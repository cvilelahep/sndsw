...
pipeline.push_back( new snd::analysis_cuts::sciFiStationCut(0., std::vector<int>(1, 2))); // C. No hits in second SciFi plane
pipeline.push_back( new snd::analysis_cuts::sciFiStationCut(0.05, std::vector<int>(1, 5))); // D. Vertex not in 5th wall
